...
print(Fore.BLUE + "[!] " + Fore.MAGENTA + "Pro Tip: Open & Use EPD on multiple Windows to get 1Gbps")
print("")
...
while True:
	...
	print(Fore.MAGENTA + "[+] " + Fore.BLUE + "EPD " + Fore.MAGENTA + "Sent %s packet to %s through port %s"%(sent, ip, port))
